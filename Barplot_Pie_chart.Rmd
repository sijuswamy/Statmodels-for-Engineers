---
title: "Plotting Catagorical Variables using R"
...
To analyse catagorical variables, let us load the data set containig informations related to the survey on Lung capacities of smokers and non smokers in a state. The data is stored in *LungCapData.txt* .
